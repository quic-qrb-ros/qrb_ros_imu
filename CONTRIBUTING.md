...
1. [Fork](https://github.com/quic-qrb-ros/qrb_ros_imu/fork) and clone the repository.
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/quic-qrb-ros/qrb_ros_imu.git
    ```
...
1. [Submit a pull request](https://github.com/quic-qrb-ros/qrb_ros_imu/pulls) from your branch to `main`.
